...
init_buy_ratio = my_lib.get_initial_ratio_single_pair(long_symbol, short_symbol, positions, SCALE_RATIO)
...
while True:
    try:
        ...
        current_ratio = my_lib.get_long_short_ratio(long_ticker, short_ticker, SCALE_RATIO)
